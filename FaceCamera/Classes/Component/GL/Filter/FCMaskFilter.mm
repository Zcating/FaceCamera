...
@implementation FCMaskFilter

const GLubyte DelaunayTriangles[] = {
    68,69,0,
    68,0,17,
    68,17,18,
    68,18,19,
...
- (void)setupImage:(UIImage *)image landmarks:(NSArray *)landmarks {
    [landmarks enumerateObjectsUsingBlock:^(NSDictionary *  _Nonnull landmark, NSUInteger index, BOOL * _Nonnull stop) {
        VertexData& data = self->_landmarkVertices[index];
